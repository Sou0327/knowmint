  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(){var t='dark';try{var s=localStorage.getItem('km-theme');if(s==='dark'||s==='light')t=s;}catch(e){}document.documentElement.classList.add(t);})();` }} />
      </head>
      <body
